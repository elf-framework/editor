...
class BaseEditor extends UIElement {
  template() {
    ...
    return /* @__PURE__ */ createElementJsx("div", { class: localClass }, pluginActivatedRef.current ? editorRef.current.getUIList("renderView") : loading);
  }
  isNotFormElement(e) {
...
function InjectView({
  ...
  return /* @__PURE__ */ createElementJsx(View, { as, style }, list);
}
export {
  BaseEditor,
  Editor,
  EditorPlugin2 as EditorPlugin,
  InjectView,
  useCommand,
  useConfig,
  useEditor,
