...
class DefaultLayout extends EditorElement {
  ...
  template() {
    ...
    return /* @__PURE__ */ createElementJsx("div", {
      ...
      class: "layout-right",
      ref: "$rightPanel"
    }, right) : "", /* @__PURE__ */ createElementJsx("div", {
      class: "splitter",
      ref: "$splitter"
...
class PopupManager extends EditorElement {
  ...
  template() {
    ...
    }, createComponent("ExportWindow"), createComponent("ProjectWindow"), createComponent("ShortcutWindow"), createComponent("NotificationView"), this.$injectManager.generate("popup", true));
  }
}
...
class BlankEditor extends BaseLayout {
  ...
  getOuterPanel() {
    return /* @__PURE__ */ createElementJsx(DefaultLayoutItem, {
      type: "outer"
    }, /* @__PURE__ */ createElementJsx(PopupManager, null), /* @__PURE__ */ createElementJsx(ContextMenuManager, null));
  }
  template() {
    return /* @__PURE__ */ createElementJsx("div", {
      class: "elf-editor"
