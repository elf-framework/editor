...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("@elf-framework/sapa"), require("@elf-framework/color"), require("@elf-framework/icon")) : typeof define === "function" && define.amd ? define(["exports", "@elf-framework/sapa", "@elf-framework/color", "@elf-framework/icon"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.elf = {}, global.sapa, global.color, global.icon));
})(this, function(exports2, sapa, Color, icon) {
  "use strict";
  ...
  class EditorElement extends sapa.UIElement {
  ...
  class DefaultLayout extends EditorElement {
    ...
    initState() {
      return {
        showLeftPanel: sapa.isNotUndefined(this.props.showLeftPanel) ? Boolean(this.props.showLeftPanel) : true,
        showRightPanel: sapa.isNotUndefined(this.props.showRightPanel) ? Boolean(this.props.showRightPanel) : true,
        topSize: sapa.isNotUndefined(this.props.topSize) ? Number(this.props.topSize) : 48,
        leftSize: sapa.isNotUndefined(this.props.leftSize) ? Number(this.props.leftSize) : 340,
        rightSize: sapa.isNotUndefined(this.props.rightSize) ? Number(this.props.rightSize) : 280,
        bottomSize: this.props.bottomSize || 20,
        lastBottomSize: this.props.lastBottomSize || 150,
        minSize: sapa.isNotUndefined(this.props.minSize) ? Boolean(this.props.minSize) : 240,
        maxSize: sapa.isNotUndefined(this.props.maxSize) ? Boolean(this.props.maxSize) : 500
      };
    }
    ...
    [sapa.POINTERSTART("$splitter") + MOVE("moveSplitter") + END("moveEndSplitter")]() {
      ...
      <div class="elf--body-panel">
        <div class='editing-area'>
          <div class="canvas-layout">
            ${sapa.createComponent("BlankCanvasView")}
          </div>
  ...
  class BaseUI extends sapa.UIElement {
    get notEventRedefine() {
      return true;
    }
    getValue() {
  ...
  class ToggleButton extends BaseUI {
    ...
    [sapa.LOAD("$body") + sapa.DOMDIFF]() {
      ...
      return `
        ...
        return sapa.createElementJsx("div", {
          class: `${it === checked ? "visible" : ""} ${it === checkedValue ? "checked" : ""}`
        }, sapa.createElementJsx("button", {
          type: "button",
          "data-index": index2,
    ...
    [sapa.CLICK("$el button") + sapa.PREVENT + sapa.STOP](e) {
  ...
  class ToggleCheckBox extends BaseUI {
    ...
    [sapa.LOAD("$body")]() {
      ...
      return `
        ...
        let title = this.state.toggleTitles[index2];
        return sapa.createElementJsx("div", null, sapa.createElementJsx("button", {
          type: "button",
  ...
  class TabPanel extends sapa.UIElement {
    initState() {
      return {
  ...
  class Tabs extends sapa.UIElement {
    afterRender() {
      window.setTimeout(() => {
    ...
    [sapa.LOAD("$tab")]() {
      ...
      return [
        /* @__PURE__ */ sapa.createElementJsx("div", {
          class: "tab-header",
          ref: "$header"
        }, children.map((it) => /* @__PURE__ */ sapa.createElementJsx("div", {
          class: "tab-item",
  ...
  class ColorViewEditor extends EditorElement {
    ...
    viewColorPicker() {
      this.emit("showColorPickerPopup", {
        target: this,
        changeEvent: (color2) => {
          this.updateData({ value: color2, color: Color__namespace.parse(color2) });
        },
        changeEndEvent: (color2) => {
          this.updateEndData({ value: color2, color: Color__namespace.parse(color2) });
        },
    ...
    [sapa.INPUT("$el .color-input input")](e) {
      ...
      this.updateData({
        value: color2,
        color: Color__namespace.parse(color2)
      });
      this.refreshColorView();
    }
    [sapa.INPUT("$el .opacity-input input")](e) {
      ...
      const color2 = Color__namespace.parse(this.state.value);
      color2.a = round(opacity / 100, 1e3);
      const value = Color__namespace.format(color2, color2.type);
      this.updateData({
        value,
        color: color2
      });
  ...
  class ComponentEditor extends EditorElement {
    ...
    getPropertyEditor(index2, childEditor) {
      if (childEditor.type === "folder") {
        ...
        <div class='component-folder'>
          <label>${icon.iconUse("chevron_right")} ${childEditor.label}</label>
          <ul>
      ...
      return sapa.createComponent(childEditor.editor, __spreadProps(__spreadValues({}, childEditor.editorOptions), {
        onchange: (key, value) => {
          const newValue = sapa.isFunction(childEditor.convert) ? childEditor.convert(key, value) : value;
    ...
    [sapa.LOAD("$body")]() {
      ...
      var self2 = inspector.map((it, index2) => {
        if (sapa.isString(it) || it.type === "label") {
    ...
    getValue() {
      const result = {};
      this.eachChildren((child) => {
        if (sapa.isFunction(child.getValue) && child.props.key) {
          result[child.props.key] = child.getValue();
        }
      });
      return result;
    }
    [sapa.SUBSCRIBE_SELF("changeComponentValue")](key, value) {
      this.parent.trigger(this.props.onchange, key, value);
    }
    [sapa.CLICK("$el .component-folder > label")](e) {
  ...
  class Length {
    constructor(value = "", unit = "") {
      this.value = value;
      if (sapa.isNumber(this.value) && isNaN(this.value)) {
        this.value = 0;
      }
      this.unit = unit;
    }
    ...
    static parse(obj2) {
      ...
      if (obj2 instanceof Length) {
        ...
        if (obj2.unit == "%" || obj2.unit == "percent") {
          var value = 0;
          if (sapa.isNotUndefined(obj2.percent)) {
            value = obj2.percent;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          return Length.percent(value);
        } else if (obj2.unit == "px") {
          var value = 0;
          if (sapa.isNotUndefined(obj2.px)) {
            value = obj2.px;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = 0;
          if (sapa.isNotUndefined(obj2.em)) {
            value = obj2.em;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = 0;
          if (sapa.isNotUndefined(obj2.deg)) {
            value = obj2.deg;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = 0;
          if (sapa.isNotUndefined(obj2.second)) {
            value = obj2.second;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = 0;
          if (sapa.isNotUndefined(obj2.ms)) {
            value = obj2.ms;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = 0;
          if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
          ...
          var value = "";
          if (sapa.isNotUndefined(obj2.str)) {
            value = obj2.str;
          } else if (sapa.isNotUndefined(obj2.value)) {
            value = obj2.value;
          }
    ...
    isNaN() {
      return sapa.isNumber(this.value) && isNaN(this.value);
    }
    set(value) {
      this.value = value;
      return this;
    ...
    stringToPercent() {
      if (sapa.isNotUndefined(stringToPercent[this.value])) {
  ...
  class InputRangeEditor extends EditorElement {
    ...
    [sapa.LOAD("$body") + sapa.DOMDIFF]() {
      var { min, max, step, label, title, compact, wide, layout: layout2, disabled } = this.state;
      label = icon.iconUse(label);
      if (sapa.isNumber(this.state.value)) {
      ...
      return `<div 
        ...
        data-type='range'><div class='area'><input type='number' class='property-number' ref='$propertyNumber' value="${realValue}" min="${min}" max="${max}" step="${step}" tabIndex="1" />${units.length === 1 ? `<span class='unit'>${units[0]}</span>` : sapa.createComponent("SelectEditor", {
        ref: "$unit",
        key: "unit",
        compact: true,
    ...
    [sapa.INPUT("$body .property-number")](e) {
    ...
    [sapa.FOCUSIN("$body input[type=number]")](e) {
      this.refs.$range.addClass("focused");
      e.$dt.select();
    }
    [sapa.FOCUSOUT("$body input[type=number]")]() {
      this.refs.$range.removeClass("focused");
    }
    [sapa.POINTERSTART("$body .elf--input-range-editor label") + MOVE("moveDrag") + END("moveDragEnd")]() {
  ...
  class NumberInputEditor extends EditorElement {
    initState() {
      ...
      let label = this.props.label || "";
      const compact = sapa.isBoolean(this.props.compact) ? this.props.compact : this.props.compact === "true";
      const wide = sapa.isBoolean(this.props.wide) ? this.props.wide : this.props.wide === "true";
      const mini = sapa.isBoolean(this.props.mini) ? this.props.mini : this.props.mini === "true";
    ...
    [sapa.INPUT("$body input[type=number]") + sapa.IF("isTriggerInput") + sapa.DEBOUNCE(500)](e) {
      this.updateValue(e);
    }
    [sapa.KEYUP("$body input[type=number]") + sapa.IF("isTriggerEnter") + sapa.ENTER](e) {
      this.updateValue(e);
      e.$dt.select();
    }
    [sapa.POINTERSTART("$body label") + MOVE("moveDrag") + END("moveDragEnd")]() {
      this.refs.$range.addClass("drag");
  ...
  class NumberRangeEditor extends EditorElement {
    ...
    [sapa.LOAD("$body")]() {
      var { min, max, step, label, layout: layout2, compact, wide, disabled } = this.state;
      var value = +this.state.value.value.toString();
      if (isNaN(value)) {
        value = 0;
      }
    ...
    [sapa.FOCUS('$body input[type="number"]')]() {
      this.refs.$propertyNumber.addClass("focused");
    }
    [sapa.BLUR('$body input[type="number"]')]() {
    ...
    [sapa.INPUT('$body input[type="number"]')]() {
  ...
  class SelectEditor extends EditorElement {
    ...
    template() {
      ...
      label = icon.iconUse(label);
      return `<div class='elf--select-editor ${hasLabel} ${compact}'>${label ? `<label title="${title}">${label}</label>` : ""}<div class="editor-view"><select ref='$options' ${hasTabIndex}>${this.getOptionString()}</select><div class='selected-value'><span class='value' ref="$selectedValue">${value}</span><span class='expand' ref='$expand'>${icon.iconUse("expand_more")}</span></div></div></div>`;
    }
    getValue() {
  ...
  class SelectIconEditor extends EditorElement {
    initState() {
      ...
      return {
        label: this.props.label || "",
        compact: sapa.isBoolean(this.props.compact) ? this.props.compact : this.props.compact === "true",
        options,
        icons,
        colors,
        value,
    ...
    [sapa.LOAD("$options") + sapa.DOMDIFF]() {
      return this.state.options.map((it, index2) => {
        ...
        if (it.value === "") {
          var label = "";
          title = "close";
          if (sapa.isNotUndefined(this.state.icons[index2])) {
            iconClass = "icon";
            label = icon.iconBlank();
            value = "__blank__";
          }
        } else {
          var iconKey = this.state.icons[index2];
          if (icon.icons[iconKey]) {
            iconClass = "icon";
          }
          title = label;
          label = icon.iconUse(iconKey) || label || iconKey || it.text || it.value;
        }
    ...
    [sapa.CLICK("$options .select-icon-item")](e) {
  ...
  class BlankInspector extends EditorElement {
    template() {
      return /* @__PURE__ */ sapa.createElementJsx("div", {
      ...
      }, /* @__PURE__ */ sapa.createElementJsx("div", null, /* @__PURE__ */ sapa.createElementJsx(Tabs, {
        ref: "$tab",
        ...
        const { value, title, icon: icon2, loadElements = [] } = it.class;
        return /* @__PURE__ */ sapa.createElementJsx(TabPanel, {
          value,
          title,
          icon: icon2
        }, /* @__PURE__ */ sapa.createElementJsx("div", {
          style: "display: flex: flex-direction: column;"
        }, loadElements == null ? void 0 : loadElements.map((element) => sapa.createElement(element)), this.$injectManager.generate("inspector.tab." + value), /* @__PURE__ */ sapa.createElementJsx("div", {
          class: "empty",
          style: "order: 1000000;"
        })));
      }))));
  ...
  class BlankLayerTab extends EditorElement {
    template() {
      return /* @__PURE__ */ sapa.createElementJsx("div", {
        class: "layer-tab"
      }, /* @__PURE__ */ sapa.createElementJsx(Tabs, {
        ref: "$tab",
        type: "side",
        direction: "left",
        ...
        return /* @__PURE__ */ sapa.createElementJsx(TabPanel, {
          ...
          style: "display: flex: flex-direction: column;"
        }, loadElements == null ? void 0 : loadElements.map((element) => sapa.createElement(element)), this.$injectManager.generate("layertab.tab." + value), /* @__PURE__ */ sapa.createElementJsx("div", {
          class: "empty",
          style: "order: 1000000;"
        })));
      })));
  ...
  function Divider() {
    return sapa.Dom.createByHTML(`<li class="dropdown-divider"></li>`);
  }
  class DropdownMenuItem extends EditorElement {
    ...
    template() {
      var _a;
      const it = this.props;
      const checked = sapa.isFunction(it.checked) ? it.checked(this.$editor) : it.checked;
      return `
          <li data-has-children="${Boolean((_a = it.items) == null ? void 0 : _a.length)}"
            ...
            ${checked ? `checked` : ""}
          >
              <span class="icon">${checked ? icon.iconUse("check") : it.icon || ""}</span>
    ...
    [sapa.CLICK("$el") + sapa.PREVENT + sapa.STOP]() {
      console.log("click", this.props.command, this.props.args);
      if (this.props.command) {
        this.$commands.emit(this.props.command, ...this.props.args || []);
      } else if (sapa.isFunction(this.props.action)) {
        this.props.action(this.$editor, this);
      } else if (sapa.isFunction(this.props.onClick)) {
        this.props.action(this.$editor, this);
      }
      if (sapa.isFunction(this.props.nextTick)) {
        this.nextTick(() => {
  ...
  class DropdownCheckboxMenuItem extends DropdownMenuItem {
    ...
    get checked() {
      if (sapa.isFunction(this.props.checked)) {
  ...
  class DropdownCustomMenuItem extends DropdownMenuItem {
    ...
    getTemplateString() {
      if (sapa.isFunction(this.props.template)) {
  ...
  function makeMenuItem(it, id) {
    if (it === "-") {
      return sapa.createComponent("Divider", {
        ref: `${id}-divider`
      });
    }
    if (it === "-" || it.type === "divider") {
      return sapa.createComponent("DropdownDividerMenuItem", {
        ref: `${id}-divider`
      });
    }
    if (sapa.isString(it)) {
      return sapa.createComponent("DropdownTextMenuItem", {
        text: it,
        ref: `${id}-text`
      });
    }
    if (it.type === "link") {
      return sapa.createComponent("DropdownLinkMenuItem", {
        href: it.href,
        target: it.target,
        title: it.title,
    ...
    if (it.type === "custom") {
      return sapa.createComponent("DropdownCustomMenuItem", {
        action: it.action,
        command: it.command,
        args: it.args,
        icon: it.icon,
    ...
    if (it.type === "checkbox") {
      return sapa.createComponent("DropdownCheckboxMenuItem", {
        checked: it.checked,
        command: it.command,
        args: it.args || [],
    ...
    if (sapa.isArray(it.items)) {
      return sapa.createComponent("DropdownMenuList", {
        title: it.title,
        items: it.items,
        ref: `${id}-list`
      });
    }
    return sapa.createComponent("DropdownMenuItem", {
      checked: it.checked,
      command: it.command,
      args: it.args || [],
      disabled: it.disabled,
    ...
    template() {
      return `
        <li class="dropdown-menu-list">
            ...
            <span>${icon.iconUse("arrowRight")}</span>              
            <ul>
  ...
  class DropdownMenu extends EditorElement {
    ...
    template() {
      ...
      return `
        <div class="${sapa.classnames("dropdown-menu", {
        opened: false
      })}" data-direction="${direction}">
          <span class='icon' ref="$icon"></span>
          <span class='label' ref='$label'></span>
          <span class='dropdown-arrow' ref="$arrow">${icon.iconUse("keyboard_arrow_down")}</span>
    ...
    [sapa.LOAD("$icon")]() {
      return sapa.isFunction(this.props.icon) ? this.props.icon(this.$editor, this) : this.props.icon;
    }
    [sapa.BIND("$label")]() {
      return {
    ...
    [sapa.BIND("$el")]() {
      const selected = sapa.isFunction(this.props.selected) ? this.props.selected(this.$editor, this) : false;
      return {
        "data-selected": !!selected,
        style: __spreadProps(__spreadValues({}, this.props.style || {}), {
          "--elf--dropdown-menu-width": this.props.width,
          "--elf--dropdown-menu-dy": sapa.isNotUndefined(this.props.dy) ? Length.px(this.props.dy) : 0
        })
      };
    }
    close() {
    ...
    checkDropdownOpen(e) {
      const ul = sapa.Dom.create(e.target).closest("dropdown-menu-item-list");
      if (!ul)
        return true;
      return false;
    }
    ...
    [sapa.CLICK("$arrow") + sapa.IF("checkDropdownOpen") + sapa.IF("checkTriggerClick")]() {
      this.toggle();
    }
    [sapa.CLICK("$label") + sapa.IF("checkDropdownOpen") + sapa.IF("checkTriggerClick")]() {
      this.toggle();
    }
    [sapa.POINTEROVER("$el") + sapa.IF("checkTriggerOver")]() {
      this.open();
    }
    [sapa.POINTEROUT("$el") + sapa.IF("checkTriggerOver")]() {
      this.hide();
    }
    [sapa.CLICK("$icon")]() {
      const selectedKey = sapa.isFunction(this.props.selectedKey) ? this.props.selectedKey(this.$editor, this) : this.props.selectedKey;
      const menuItem = this.findItem(selectedKey);
      if (!menuItem) {
        if (sapa.isFunction(this.props.action)) {
          this.props.action(this.$editor, this);
        }
        return;
      }
      ...
      } else if (action && sapa.isFunction(action)) {
        this.emit(action);
      }
      if (nextTick && sapa.isFunction(nextTick)) {
        this.nextTick(() => {
    ...
    [sapa.SUBSCRIBE_SELF("updateMenuItems")](items) {
      this.setState({ items });
    }
    [sapa.SUBSCRIBE("hideDropdownMenu")]() {
      this.close();
    }
  ...
  class ToolbarButtonMenuItem extends EditorElement {
    ...
    [sapa.LOAD("$el") + sapa.DOMDIFF]() {
      let result = "";
      if (this.props.icon) {
        const iconName = sapa.isFunction(this.props.icon) ? this.props.icon(this.$editor) : this.props.icon;
        result += `<span class="icon">${icon.iconUse(iconName)}</span>`;
      }
      if (this.props.title) {
    ...
    [sapa.BIND("$el")]() {
      const selected = sapa.isFunction(this.props.selected) ? this.props.selected(this.$editor) : false;
      const disabled = sapa.isFunction(this.props.disabled) ? this.props.disabled(this.$editor) : this.props.disabled;
      return {
  ...
  class ToolBarRenderer extends EditorElement {
    ...
    renderButton(item, index2) {
      return sapa.createComponent("ToolbarButtonMenuItem", {
        ref: "$button-" + index2,
        title: item.title,
    ...
    renderDropdown(item, index2) {
      return sapa.createComponent("DropdownMenu", __spreadProps(__spreadValues({
        ref: "$dropdown-" + index2
      }, item), {
        items: item.items,
        icon: item.icon,
  ...
  class BlankToolBar extends EditorElement {
    ...
    template() {
      return `
            <div class='elf--blank-tool-bar'>
              <div class="logo-area">
                ${sapa.createComponent("ToolBarRenderer", {
    ...
    [sapa.SUBSCRIBE("updateMenu")](target) {
  ...
  class ColorManagerV2 {
    ...
    changeColor(colorObj) {
      ...
      if (typeof colorObj === "string") {
        colorObj = Color__namespace.parse(colorObj);
      }
      ...
      if (colorObj.type == "hsl") {
        ...
        this.state.rgb = Color__namespace.HSLtoRGB(this.state.hsl);
        this.state.hsv = Color__namespace.HSLtoHSV(colorObj);
      } else if (colorObj.type == "hex") {
        this.state.rgb = __spreadValues(__spreadValues({}, this.state.rgb), colorObj);
        this.state.hsl = Color__namespace.RGBtoHSL(this.state.rgb);
        this.state.hsv = Color__namespace.RGBtoHSV(colorObj);
        ...
        this.state.rgb = Color__namespace.HSVtoRGB(this.state.hsv);
        this.state.hsl = Color__namespace.HSVtoHSL(this.state.hsv);
      }
    }
    getHueColor() {
      return Color__namespace.checkHueColor(this.state.hsv.h / 360);
    }
    toString(type) {
      type = type || this.state.format;
      var colorObj = this.state[type] || this.state.rgb;
      return Color__namespace.format(__spreadProps(__spreadValues({}, colorObj), { a: this.state.alpha }), type);
    }
    toColor(type) {
  ...
  class ColorInformation extends EditorElement {
    ...
    [sapa.INPUT("$rgb_r") + sapa.IF("hasValue")]() {
      this.changeRgbColor();
    }
    [sapa.INPUT("$rgb_g") + sapa.IF("hasValue")]() {
      this.changeRgbColor();
    }
    [sapa.INPUT("$rgb_b") + sapa.IF("hasValue")]() {
      this.changeRgbColor();
    }
    [sapa.INPUT("$rgb_a") + sapa.IF("hasValue")]() {
      this.changeRgbColor();
    }
    [sapa.INPUT("$hsl_h") + sapa.IF("hasValue")]() {
      this.changeHslColor();
    }
    [sapa.INPUT("$hsl_s") + sapa.IF("hasValue")]() {
      this.changeHslColor();
    }
    [sapa.INPUT("$hsl_l") + sapa.IF("hasValue")]() {
      this.changeHslColor();
    }
    [sapa.INPUT("$hsl_a") + sapa.IF("hasValue")]() {
      this.changeHslColor();
    }
    [sapa.KEYUP("$hexCode") + sapa.IF("hasValue")]() {
      var code = this.refs.$hexCode.val();
      if (code.charAt(0) == "#" && (code.length == 7 || code.length === 9)) {
        this.parent.lastUpdateColor(code);
      }
    }
    [sapa.PASTE("$hexCode") + sapa.IF("hasValue")]() {
      var code = this.refs.$hexCode.val();
      if (code.charAt(0) == "#" && (code.length == 7 || code.length === 9)) {
        this.parent.lastUpdateColor(code);
      }
    }
    [sapa.CLICK("$formatChangeButton")]() {
      this.nextFormat();
    }
    [sapa.CLICK("$el .information-item.hex .input-field .title")]() {
      this.goToFormat("hex");
    }
    [sapa.CLICK("$el .information-item.rgb .input-field .title")]() {
      this.goToFormat("hsl");
    }
    [sapa.CLICK("$el .information-item.hsl .input-field .title")]() {
      this.goToFormat("rgb");
    }
    setRGBInput() {
  ...
  class ColorPalette extends EditorElement {
    ...
    [sapa.POINTERSTART("$el") + MOVE("movePointer") + END("moveEndPointer")]() {
      this.rect = this.$el.rect();
      this.refreshColorUI();
    }
    movePointer() {
  ...
  class Hue extends EditorElement {
    ...
    [sapa.POINTERSTART("$container") + MOVE("movePointer") + END("moveEndPointer")]() {
  ...
  class Opacity extends EditorElement {
    initState() {
      return {
        colorbar: Color__namespace.parse("rgba(0, 0, 0, 1)"),
        opacity: 0,
        minValue: 0,
        maxValue: 100
      };
    ...
    [sapa.BIND("$colorbar")]() {
      const rgb = sapa.clone(this.state.colorbar);
      rgb.a = 0;
      const start = Color__namespace.format(rgb, "rgb");
      rgb.a = 1;
      const end = Color__namespace.format(rgb, "rgb");
      return {
        style: {
  ...
  class ColorPickerEditor extends EditorElement {
    ...
    [sapa.SUBSCRIBE_SELF("selectColorAssets")](key, color2) {
      ...
      return `
        <div class='colorpicker sketch inline'>
            <div class='colorpicker-body'>
                ${sapa.createComponent("Palette", { ref: "$palette" })}
                <div class="control">
                    ${sapa.createComponent("Hue", { ref: "$hue" })}
                    ${sapa.createComponent("Opacity", { ref: "$opacity" })}
                    <div class="empty"></div>
                    ${sapa.createComponent("ColorView", {
        ref: "$colorview"
      })}                    
                </div>
                ${sapa.createComponent("ColorInformation", {
        ref: "$information"
      })}                
                ${this.$context.injectManager.generate("colorpicker")}
                ${sapa.createComponent("ColorAssetsEditor", {
        ref: "$colorAsset",
        key: "colorAssets",
  ...
  class BasePopup extends EditorElement {
    ...
    <div class='elf--popup ${this.getClassName()}'>
      <div class='popup-title' ref="$title">
        ...
        <span class="tools">
          ${this.getTools()}
          <button type='button' class='close' ref='$close'>${icon.iconUse("close")}</button>
        </span>
      </div>
    ...
    [sapa.POINTERSTART("$title") + MOVE("movePopupTitle") + END("endPopupTitle")]() {
    ...
    [sapa.SUBSCRIBE("hidePropertyPopup")]() {
      this.hide();
    }
    [sapa.POINTERSTART("$resizer") + MOVE("moveResizer")]() {
  ...
  `;
    ...
    [sapa.CLICK("$projectColors .color-view")](e) {
      this.updateData({
        color: e.$dt.attr("data-color")
      });
      this.children.$color.setValue(this.state.color);
    }
    [sapa.SUBSCRIBE("showColorPickerPopup")](data, params, rect) {
      data.changeEvent = data.changeEvent || "changeFillPopup";
      if (!(data.target instanceof sapa.UIElement)) {
    ...
    [sapa.SUBSCRIBE("hideColorPickerPopup")]() {
      this.hide();
    }
  }
  class EmbedColorPicker extends EditorElement {
    ...
    template() {
      return `
        <div class='embed-color-picker'>
          ${sapa.createComponent("ColorPickerEditor", {
        ref: "$colorpicker",
        key: "colorpicker",
        value: this.state.value,
    ...
    [sapa.SUBSCRIBE_SELF("localChangeColor")](key, color2) {
      this.parent.trigger(this.props.onchange, color2);
    }
    [sapa.SUBSCRIBE_SELF("localLastUpdate")](key, color2) {
  ...
  class BaseProperty extends EditorElement {
    ...
    refreshShow(type, isRefresh = true) {
      var current = this.$context.selection.current;
      if (current) {
        if (sapa.isFunction(type) && type()) {
          this.show();
          if (isRefresh)
            this.refresh();
        } else {
          if (!sapa.isFunction(type) && type.includes(current.itemType)) {
            this.show();
            if (isRefresh)
              this.refresh();
          } else {
  ...
  class NotificationView extends EditorElement {
    ...
    [sapa.TRANSITIONEND("$el")](e) {
      sapa.Dom.create(e.target).remove();
    }
    [sapa.CLICK("$el .item > .icon")](e) {
      e.$dt.parent().remove();
    }
    getMessageTemplate(type, title, description, duration = 1e3) {
      return `
        <div class='item ${type}' style='transition-duration: ${duration}ms;'>
            ...
            <span class='icon'>${icon.iconUse("close")}</span>
        </div>
    `;
    }
    [sapa.SUBSCRIBE(SHOW_NOTIFY)](type, title, description, duration = 1e3) {
      const $dom = sapa.Dom.createByHTML(this.getMessageTemplate(type, title, description, 1e3));
      this.$el.prepend($dom);
  ...
  class ShortcutWindow extends BaseWindow {
    ...
    [sapa.SUBSCRIBE("showShortcutWindow")]() {
      this.show();
    }
  }
  sapa.registElement({ ShortcutWindow });
  ...
  class BlankEditor extends BaseLayout {
    ...
    template() {
      return /* @__PURE__ */ sapa.createElementJsx("div", {
        class: "elf-editor"
      }, /* @__PURE__ */ sapa.createElementJsx(DefaultLayout, {
    ...
    [sapa.CONFIG("show.left.panel")]() {
      this.children.$layout.setOptions({
        showLeftPanel: this.$config.get("show.left.panel")
      });
    }
    [sapa.CONFIG("show.right.panel")]() {
      this.children.$layout.setOptions({
        showRightPanel: this.$config.get("show.right.panel")
      });
    }
  ...
  class ObjectProperty {
    static create(json) {
      return class extends BaseProperty {
        ...
        get order() {
          return sapa.isUndefined(json.order) ? 1e3 : json.order;
        }
        afterComponentRendering($dom, refName, instance) {
          var _a;
          if (refName == "$comp") {
            const current = ((_a = this.$context.selection) == null ? void 0 : _a.current) || {};
            const inspector = sapa.isFunction(json.inspector) ? json.inspector(current) : this.$context.components.createInspector(current, json.editableProperty);
  ...
  class ContextMenuRenderer extends EditorElement {
    ...
    renderDropdown(item, index2) {
      return sapa.createComponent("ContextDropdownMenu", __spreadProps(__spreadValues({
        ref: "$dropdown-" + index2
      }, item), {
        items: item.items,
        icon: item.icon,
  ...
  class ContextMenuView extends EditorElement {
    ...
    [sapa.LOAD("$el")]() {
      ...
      return /* @__PURE__ */ sapa.createElementJsx(ContextMenuRenderer, {
        items: [{ type: "dropdown", items: [...items, ...info.items || []] }]
      });
    }
    [sapa.CONFIG("context.menu.open")]() {
      this.refresh();
  ...
  function createBlankEditor(opts) {
    return sapa.start(BlankEditor, opts);
  }
  ...
  exports2.BasePopup = BasePopup;
  exports2.BaseProperty = BaseProperty;
  exports2.BaseUI = BaseUI;
  exports2.BlankEditor = BlankEditor;
  exports2.Button = Button;
  exports2.CSS_TO_STRING = CSS_TO_STRING;
  exports2.ColorSingleEditor = ColorSingleEditor;
  exports2.ColorViewEditor = ColorViewEditor;
  exports2.ComponentEditor = ComponentEditor;
  exports2.ContextDropdownMenu = ContextDropdownMenu;
  exports2.ContextMenuView = ContextMenuView;
  exports2.DefaultLayout = DefaultLayout;
  exports2.DefaultLayoutItem = DefaultLayoutItem;
  exports2.DirectionLength = DirectionLength;
  exports2.END = END;
  exports2.END_GUESTURE = END_GUESTURE;
  exports2.EditingMode = EditingMode;
  exports2.Editor = Editor;
  exports2.EditorElement = EditorElement;
  exports2.FIRSTMOVE = FIRSTMOVE;
  exports2.InputArrayEditor = InputArrayEditor;
  exports2.InputRangeEditor = InputRangeEditor;
  ...
  exports2.NumberInputEditor = NumberInputEditor;
  exports2.NumberRangeEditor = NumberRangeEditor;
  ...
  exports2.RangeEditor = RangeEditor;
