...
<button class="elf--button default medium round ">
  <span>
    <div
      class="elf--animation"
      style="--elf--animation-duration: 1s; --elf--animation-name: spin; --elf--animation-delay: 0s; --elf--animation-play-state: running;"
    >
      <div
        class="elf--progress-circle default medium normal"
        style="--elf--progress-circle-offset: 0.5;"
      >
