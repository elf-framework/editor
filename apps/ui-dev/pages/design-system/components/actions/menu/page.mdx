...
title: Menu
layout: DesignLayout
filename: pages/design-system/components/actions/menu/page.mdx
---
...
<menu data-direction="left" class="elf--menu menu light" style="position: relative;">
    <li>
    ...
    <li class="hover">
        ...
        <menu data-direction="right" class="elf--menu menu light">
            <li>
                <div class="menu-item-content"><span class="selected-icon"></span>
