...
<div
  class="elf--action-group horizontal normal"
  style="--elf--action-group-gap: 10px; margin: 10px;"
>
...
<div
  class="elf--action-group horizontal compact normal"
  style="--elf--action-group-gap: 10px; margin: 10px;"
>
...
```html
<div
  class="elf--action-group horizontal compact justified normal"
  style="--elf--action-group-gap: 10px; margin: 10px;"
>
  <button class="elf--button default medium rect ">
    <span> Settings</span>
