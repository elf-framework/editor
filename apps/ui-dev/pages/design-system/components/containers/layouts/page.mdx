...
title: Layout
layout: DesignLayout
filename: pages/design-system/containers/layouts/page.mdx
---
...
<div class="elf--grid" style="grid-template-columns: 1fr 1fr 1fr; grid-template-rows: 100px 100px; gap: 10px;">
...
<div>
    <Flex style={{gap: 20, justifyContent: "flex-end", backgroundColor: "var(--color-gray-0)", padding: 10, marginBottom: 10}}>
        <Ghost style={{height: 100,width: 100, backgroundColor: "var(--color-gray-2)"}} />
        <Ghost style={{height: 100,width: 100, backgroundColor: "var(--color-gray-2)"}} />
    </Flex>
</div>
...
<div>
    <Flex style={{gap: 20, flexDirection: "column", width: 200, height: 200, alignContent: "flex-start", backgroundColor: "var(--color-gray-0)", padding: 10, marginBottom: 10}}>
...
<Flex wrap style={{gap: 30, justifyContent: "flex-start", backgroundColor: "var(--color-gray-0)", padding: 10, marginBottom: 10}}>
    <Ghost style={{height: 100,width: 100, backgroundColor: "var(--color-gray-2)"}}>100</Ghost>
    <Ghost style={{height: 100,width: 100, backgroundColor: "var(--color-gray-2)"}}>100</Ghost>
    <Ghost style={{height: 100, width: 200 }}>200</Ghost>
    <Ghost style={{height: 100,width: 100, backgroundColor: "var(--color-gray-2)"}}>100</Ghost>
...
<Grid columns="repeat(auto-fit, minmax(100px, 1fr))" rows={['100px', '100px']} style={{gap: 10}}>
    <Ghost>1</Ghost>
    <Ghost>2</Ghost>
    <Ghost>3</Ghost>
</Grid>
