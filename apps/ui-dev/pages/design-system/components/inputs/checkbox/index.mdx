...
<CodeView>
  <CodeViewItem title="Sapa">
```jsx {3} showLineNumbers
<Checkbox size="small" checked>Label</Checkbox>
<Checkbox size="medium" checked>Label</Checkbox>
<Checkbox size="large" checked>Label</Checkbox>
<Checkbox size="extra-large" checked>Label</Checkbox>
```
  </CodeViewItem>
</CodeView>
