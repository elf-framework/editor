      ...
      <div style="display: grid; grid-template-columns: 300px 1fr 1fr;column-gap: 30px;">
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; row-gap: 30px;">
            ...
            <div>
              <h3>Placeholder</h3>
              <InputEditor value={this.state.value} placeholder="Value,...."/>
            </div>            
            <div>
              <h3>Number</h3>
              <InputEditor type="number" value={"11123213213"} hover={true} onSelect={(e, item) => console.log('selected')}  />
            </div>
            <div>
              <h3>Password</h3>
            ...
            <div>
              <InputEditor type="textarea" focus={true} onBlur={(e, item) => console.log(item.value)} />
            </div>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; row-gap: 30px;">
            <div>
              ...
              <InputEditor value={this.state.value} icon={iconUse("artboard")}/>
            </div>
            <div>
              <h3>Multi line</h3>
